            ...
            <div className="w-[85%] md:w-[50%] mx-auto pt-6 md:pt-8 pb-3">
              <div className="w-full flex flex-col group">
                ...
                <div
                  ...
                  class="mt-1 mb-6 relative border rounded-xl flex items-center h-10 focus-within:border-light-purple focus:shadow-border-focus border-error-red shadow-border-error"
                >
                  <div class="relative flex items-center h-full z-[2] w-full">
                    <input
                      class="focus:outline-none pl-3 w-full h-full rounded-xl pr-8"
                      type="text"
                      {...register("recipient.name")}
                    />
                  </div>
                  <p class="min-h-[1rem] text-xs text-error-red absolute top-10 mt-0.5 ml-0.5 ">
                    Required
                  </p>
                </div>
              </div>
              ...
              <div class="group">
                ...
                <div class="flex h-10 mt-1 mb-6 relative rounded-xl border focus-within:border-light-purple focus-within:shadow-border-focus border-border-dark-gray shadow-border">
                  <div class="relative text-gray-4 text-sm">
                    ...
                    <select
                      ...
                      tabindex="-1"
                      {...register("recipient.countryCallCode")}
                    >
                      <option value="" disabled=""></option>
                    ...
                    <div
                      class="h-full flex items-center min-w-[40px] px-3 justify-center"
                      aria-hidden="true"
                    >
                  ...
                  <input
                    ...
                    class="block w-full pl-3 pr-10 py-2.5 text-gray-4 disabled:bg-gray-2 text-sm rounded-xl focus:outline-none"
                    {...register('recipient.mobile')}
                  />
                  <svg
                    viewBox="0 0 22 22"
                    fill="none"
