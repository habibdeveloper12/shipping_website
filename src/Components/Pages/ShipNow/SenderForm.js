                    ...
                    <div className="w-full">
                        <div className="bg-white w-full md:rounded-xl">
                            <div className="w-[85%] md:w-[50%] mx-auto pt-6 pb-10 md:pt-8">
                                ...
                                <label
                                    for="shipping-from"
                                    className="font-normal text-subheading-gray"
                                >
                                    Shipping From
                                </label>
                                <input
                                    ...
                                    <div className="flex h-10 mt-1 mb-6 relative rounded-xl border focus-within:border-light-purple focus-within:shadow-border-focus border-border-dark-gray shadow-border">
                                        <div className="relative text-gray-4 text-sm">
                                            <select
                                                ...
                                                tabindex="-1"
                                                {...register("sender.countryCallCode")}
                                            >
                            ...
                            <div className="flex flex-col bg-white md:rounded-xl py-6">
                                ...
                                <div className="w-[85%] md:w-full md:px-8 mx-auto">
                                    <div className="grid md:grid-cols-3 md:grid-rows-2 gap-4 lg:gap-x-6 place-items-center">
                                        <div>
                                            <input id="commercial-b2b" type="radio" name="purpose" value="Commercial B2B" {...register("sender.purpose")} className="hidden peer" />
                                            <label htmlFor="commercial-b2b" className="form-input w-full h-[60px] hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl   border-black border-2">
                                                <div className="block">
                                                    <p>Commercial</p>
                                                    <p>B2B items</p>
                                                </div>
                                        ...
                                        <div>
                                            <input id="gift" type="radio" name="purpose" value="Gift" required {...register("sender.purpose")} className="hidden peer" />
                                            <label htmlFor="gift" className="form-input w-full h-[60px] hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl   border-black border-2">
                                                <div className="block">
                                                    <p>Gift</p>
                                                </div>
                                            </label>
                                        ...
                                        <div>
                                            <input id="samples" type="radio" name="purpose" value="Samples for a prospect" {...register("sender.purpose")} className="hidden peer" />
                                            <label htmlFor="samples" className="form-input w-full h-[60px] hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl   border-black border-2">
                                                <div className="block">
                                                    <p>Samples for a prospect</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div>
                                            <input id="defective" type="radio" name="purpose" value="Defective items for repair & return" required {...register("sender.purpose")} className="hidden peer" />
                                            <label htmlFor="defective" className="form-input w-full h-[60px] hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl   border-black border-2">
                                                <div className="block">
                                                    <p>Defective items for repair & return</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div>
                                            <input id="goods" type="radio" name="purpose" value="New goods for individual's use" {...register("sender.purpose")} className="hidden peer" />
                                            <label htmlFor="goods" className="form-input w-full h-[60px] hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl   border-black border-2">
                                                <div className="block">
                                                    <p>New goods for individual's use</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div>
                                            <input id="used-belongings" type="radio" name="purpose" value="Used Belongings" required {...register("sender.purpose")} className="hidden peer" />
                                            <label htmlFor="used-belongings" className="form-input w-full h-[60px] hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl   border-black border-2">
                                                <div className="block">
                                                    <p>Used Belongings</p>
                                                </div>
                                            </label>
