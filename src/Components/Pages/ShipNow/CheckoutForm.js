          ...
          <div className='md:grid grid-cols-[68%_32%] gap-x-12 relative'>
            ...
            <div>
              <div className='self-start bg-white rounded-xl md:sticky top-32 py-8 px-6 text-subheading-gray text-sm'>
                ...
                <button type="button" id="cart-Form-button" class="pill-button button-hover bg-light-purple hover:bg-dark-purple text-base text-white w-full h-[45px] mx-auto mt-12 md:mt-0 disabled:cursor-not-allowed disabled:bg-disabled-purple disabled:border-transparent">Proceed to PayNow</button>
